        ...
        {lineHeights.map(({ label, value }) => (
          <button
            ...
            className={cn(
              ...
              editor?.getAttributes("paragrapgh").lineHeight === value && "bg-neutral-200/80"
            )}
          >
  ...
  return (
    <div className="flex items-center gap-x-0.5">
      <button
        onClick={decrement}
        className={
          "h-7 w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80"
        }
      >
